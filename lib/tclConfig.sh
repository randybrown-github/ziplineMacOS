...
# installed.
TCL_PREFIX='/var/root/anaconda3/envs/env_zipline'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/var/root/anaconda3/envs/env_zipline'
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/var/root/anaconda3/envs/env_zipline/lib -L/var/root/anaconda3/envs/env_zipline/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/var/root/anaconda3/envs/env_zipline/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/var/root/anaconda3/envs/env_zipline/include'
...
TCL_PACKAGE_PATH='/var/root/anaconda3/envs/env_zipline/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/var/root/anaconda3/envs/env_zipline/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/var/root/anaconda3/envs/env_zipline/lib/libtclstub8.6.a'
