...
# installed.
TK_PREFIX='/var/root/anaconda3/envs/env_zipline'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/var/root/anaconda3/envs/env_zipline'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/var/root/anaconda3/envs/env_zipline/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/var/root/anaconda3/envs/env_zipline/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/var/root/anaconda3/envs/env_zipline/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/var/root/anaconda3/envs/env_zipline/lib/libtkstub8.6.a'
